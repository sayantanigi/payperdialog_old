                                            ...
                                            foreach ($recomendedJobList as $key) {
                                                ...
                                                <div class="emply-resume-list">
                                                    ...
                                                    <div class="emply-resume-info">
                                                        <h3><a href="<?= base_url('postdetail/' . base64_encode($key['id'])) ?>"
                                                                title="">
                                                                <?= $key['post_title'] ?>
                                                            </a></h3>
                                                        <span>
                                                        ...
                                                        <span>
                                                            <?= $get_subcategory->sub_category_name ?>
                                                        </span>
                                                        ...
                                                        <div class="Employee-Details">
                                                            <div class="MoreDetailsTxt_<?= $key['id'] ?>">
                                                                <?= $string ?>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <div class="CustomBlock">
        ...
        foreach ($availableData as $value) { ?>
            ...
            <div style='width: 100%; display: inline-block; padding: 0 10px; margin-bottom: 20px;'>
                <div
                    style='width: 100%; display: inline-block; border-radius: 10px; box-shadow: 0 0 10px #dddddd; padding: 10px 0 10px 0;'>
                    ...
                    for ($i = 0; $i < count($getBookSlot); $i++) { ?>
                        ...
                        ?>
                        <div
                            style='width: 100%;float: left;display: flex; position: relative; align-items: center; justify-content: space-between; flex-direction: row;'>
                            <p
                                style='width: 100%;display: inline-block;float: left;margin: 0px;font-size: 12px; padding-left: 20px;'>
