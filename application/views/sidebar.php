...
<section class="dashboard-gig User_Sidemenu max_height EmployersTheme ExpertsTheme EmployeesTheme">
    <div class="<?php if($_SESSION['afrebay']['userType'] == '1' || $_SESSION['afrebay']['userType'] == '3') {echo "container-fluid";} else {echo "container";}?> display-table" style="display: block;">
        ...
        <div class="row display-table-row">
            <div class="<?php if($_SESSION['afrebay']['userType'] == '1' || $_SESSION['afrebay']['userType'] == '3') {echo "col-md-2";} else {echo "col-md-12 col-md-12";}?> col-sm-12 hidden-xs for-mobile-sidemenu display-table-cell v-align box" id="navigation">
                <div class="navi">
                    <ul>
                        <?php if ($get_setting->required_subscription == '1') { ?>
                            <li <?php if ($seg1 == 'subscription') { ?> class="active" <?php } ?> <?php if($_SESSION['afrebay']['userType'] == '2') { echo "style='width: auto !important'"; }?>>
                                ...
                                if (!empty($get_sub_data)) {
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <li <?php if ($seg1 == 'workexperience-list') { ?>class="active" <?php } ?>>
                                            ...
                                            <a href="<?= base_url('workexperience-list') ?>"><i class="fa fa-id-card"
                                                    aria-hidden="true"></i>
                                                <span class="hidden-xs hidden-sm">Work Experience</span>
                                            </a>
                                        </li>
                            ...
                            if (@$_SESSION['afrebay']['userType'] == '2') {
                                ...
                                <?php } else { ?>
                                    ...
                                    <li <?php if ($seg1 == 'recommended-employee') { ?> class="active" <?php } ?> <?php if($_SESSION['afrebay']['userType'] == '2') { echo "style='width: auto !important'"; }?>>
                                        ...
                                        <a href="<?= base_url('recommended-employee') ?>"><i class="fa fa-tasks"
                                                aria-hidden="true"></i>
                                            <span class="hidden-xs hidden-sm">Ready for Interview</span>
                                        </a>
                                    </li>
                                        ...
                                        <li <?php if ($seg1 == 'chat') { ?>class="active" <?php } ?> <?php if($_SESSION['afrebay']['userType'] == '2') { echo "style='width: auto !important'"; }?>>
                                            ...
                                            <a href="javascript:void(0)" onclick="completeSub()"><i class="fa fa-commenting"
                                                ...
                                                if ($countMessage[0]->msgcount != 0) { ?>
                                                    <span class="notification notificationv1">
                                                        <?php echo $countMessage[0]->msgcount; ?>
                                                    </span>
                                                <?php } ?>
                                                <span class="notification notificationv">
                                                    <?php echo $countMessage[0]->msgcount; ?>
                                                </span>
                                            </a>
                                        </li>
                                    ...
                                    if (empty($profile_check[0]['firstname']) || empty($profile_check[0]['lastname']) || empty($profile_check[0]['email']) || empty($profile_check[0]['gender']) || empty($profile_check[0]['address']) || empty($profile_check[0]['short_bio'])) { ?>
                                        <li <?php if ($seg1 == 'chat') { ?>class="active" <?php } ?>>
                                            ...
                                            <a href="javascript:void(0)" onclick="completeSub()"><i class="fa fa-commenting"
                                                ...
                                                $countMessage = $this->db->query("Select COUNT(id) as msgcount FROM chat WHERE userto_id ='" . $_SESSION['afrebay']['userId'] . "' AND status = '0'")->result();
                                                if ($countMessage[0]->msgcount != 0) { ?>
                                                    <span class="notification notificationf1">
                                                        <?php echo $countMessage[0]->msgcount; ?>
                                                    </span>
                                                <?php } ?>
                                                <span class="notification notificationf">
                                                    <?php echo $countMessage[0]->msgcount; ?>
                                                </span>
                                            </a>
                                        </li>
                    ...
                    <input type="hidden" name="userto_id" id="userto_id"
                        value="<?php echo @$_SESSION['afrebay']['userId'] ?>">
                </div>
            </div>
            <style>
                .completeSub {
                ...
                <?php if ($_SESSION['afrebay']['userType'] == '2') { ?>
                    ...
                    .dashboard-gig.EmployersTheme .navi ul li a {
                        background: #def7ff !important;
                        color: #39839b !important;
                    }
                    .dashboard-gig.EmployersTheme .navi ul li a i {
                        color: #39839b !important;
                    }
                    .dashboard-gig.EmployersTheme hr {
                        border-top: 1px solid #39839b !important;
                    }
                    .dashboard-gig.EmployersTheme .form-design form .cardak .profile-dsd input {
                        background: #fff !important;
                    }
                    .dashboard-gig.EmployersTheme .text-success-msg {
                        color: #39839b !important;
                    }
                    .User_Sidemenu .hidden-xs.display-table-cell .navi ul li a {
                        padding: 15px 15px !important;
                        ...
                        box-shadow: inset 0 0 10px #e1e1e1 !important;
                        border-radius: 10px 10px 0 0 !important;
                        background: #def7ff !important;
                    }
                    .User_Sidemenu .hidden-xs.display-table-cell .navi ul li.active a {
                        box-shadow: 0 -3px 10px #e1e1e1 !important;
                        border-radius: 10px 10px 0 0 !important;
                        background: #fff !important;
                    }
                    .dashboard-gig .display-table .display-table-row .display-table-cell.v-align {margin-top: 10px !important;}
                    .User_Sidemenu .hidden-xs.display-table-cell .navi ul li.active a i, .User_Sidemenu .hidden-xs.display-table-cell .navi ul li.active a span {color: #39839b !important}
                <?php } else if ($_SESSION['afrebay']['userType'] == '3') { ?>
                        ...
                        .dashboard-gig.ExpertsTheme .navi ul li a {
                            background: #f0fff0 !important;
                            color: #318131 !important;
                        }

                        .dashboard-gig.ExpertsTheme .navi ul li a i {
                            color: #318131 !important;
                        }

                        .dashboard-gig.ExpertsTheme hr {
                            border-top: 1px solid #318131 !important;
                        }

                        .dashboard-gig.ExpertsTheme .form-design form .cardak .profile-dsd input {
                            background: #fff !important;
                        }
                ...
                <?php } else { ?>
                        ...
                        .dashboard-gig.EmployeesTheme .navi ul li a {
                            background: #fff !important;
                        }
                        ...
                        .dashboard-gig.EmployeesTheme .navi ul li a i {
                            color: #ED1C24 !important;
                        }

                        .dashboard-gig.EmployeesTheme hr {
                            border-top: 1px solid #ddd !important;
                        }

                        .dashboard-gig.EmployeesTheme .form-design form .cardak .profile-dsd input,
                        .dashboard-gig.EmployeesTheme .Admin_Profile .cardak .gender select {
                            background: #fff !important;
                        }

                        .dashboard-gig.EmployeesTheme .Admin_Profile .cardak .key-skill .pf-field {
                            padding: 0 !important;
                        }

                        .dashboard-gig.EmployeesTheme .text-success-msg {
                            color: #ED1C24 !important;
                        }
                        .dashboard-gig li, ul{padding: 0px !important;}
                <?php } ?>
            </style>
            <script>
