												...
												<div class="row">
													...
													<div class="col-md-12">
														<div class="form-group">
															...
															<label class="switch">
																<input type="checkbox" id = "required_subscription" name = "required_subscription" <?php if($row->required_subscription == '1') { echo 'checked';}?> value = "<?= $row->required_subscription;?>">
