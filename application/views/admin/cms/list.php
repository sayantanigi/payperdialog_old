                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="#" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Description <span style="color:red;">*</span> <span
                            ...
                            <div class="mt-4">
                                <button class="btn btn-primary" type="button"
                                    onclick="return create_cms();">Submit</button>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="#" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Description <span style="color:red;">*</span> <span
                                        id="edit_description_err"></span></label>
                                <textarea class="form-control" name="description1" id="edit_description"></textarea>
                            </div>

                            <input type="hidden" name="id" id="id">
                            <div class="mt-4">
                                <button class="btn btn-primary" type="button" onclick="return update_cms();">Save
                                    Changes</button>
                                <a href="#" class="btn btn-link" data-dismiss="modal">Cancel</a>
                            </div>
                        </form>
