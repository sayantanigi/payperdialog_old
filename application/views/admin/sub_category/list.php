                    ...
                    <div class="row filter-row">
                        <div class="col-sm-6 col-md-4">
                            <div class="form-group">
                                <label>Subindustries</label>
                                <select class="form-control select filter_search_data6" name="">
                                    <option value="">Select Subindustries</option>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="#" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Industry Name <span style="color:red;">*</span> <span id="category_err"></span></label>
                            ...
                            <div class="form-group">
                                <label>Sub Industry <span style="color:red;">*</span> <span id="sub_category_name_id_err"></span></label>
                                <input class="form-control" type="text" name="sub_category_name" id="sub_category_name_id">
                            </div>
                            <div class="form-group">
                                <label>Sub Industry Image</label>
            ...
            <div class="modal-body">
                <div class="card">
                    <div class="card-body">
                        <form action="#" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Industry Name <span style="color:red;">*</span> <span id="edit_category_err"></span></label>
                            ...
                            <div class="form-group">
                                <label>Sub Industry <span style="color:red;">*</span> <span id="edit_sub_category_name_id_err"></span></label>
