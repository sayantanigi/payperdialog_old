                ...
                <div class="card">
                    <div class="card-body">
                        <div class="nav flex-column">
                            <?php if (!empty($get_email)) {
                                foreach ($get_email as $item) { ?>
                                    <a class="nav-link" data-toggle="tab" href="#<?= $item->id ?>"
                                        onclick="return get_data('<?= $item->id ?>')">
                ...
                <div class="card">
                    <div class="card-body p-0">
                        ...
                        <form method="post" action="#">
                            <div class="alert alert-success" id="success_msg" style="display:none;">Email template
                                updated successfully !</div>
                            <div class="tab-content pt-0">
                                <div class="card mb-0">
                                    <div class="card-header">
                                        <h4 class="card-title" id="email_title"><?= ucfirst(@$get_email[0]->title) ?>
                                        </h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="description"
                                                id="description"><?= @$get_email[0]->description ?></textarea>
                                        </div>
                                        <!-- <div class="form-group">
                                ...
                                <div class="card-body pt-0">
                                    <button type="button" class="btn btn-primary" onclick="return update_email()">Save
                                        Changes</button>
                                </div>
